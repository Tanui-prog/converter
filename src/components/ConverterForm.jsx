...
const ConverterForm = () => {
    ...
    const getExchangeRate = async () => {
        ...
        try {
            ...
            if (!response.ok) throw Error("Something went wrong!");{
                ...
                const rate  = (data.conversion_rate * amount ).toFixed(6);
    ...
    useEffect(() => getExchangeRate ,[fromCurrency, toCurrency, amount])
  ...
  return (
    ...
    <div className="form-group form-currency-group">
      <div className="form-section  ">
        ...
        <CurrencySelect 
        selectedCurrency={fromCurrency} handleCurrency={e => setFromCurrency(e.target.value)}
        />
      </div>
      ...
      <div className="form-section">
        ...
        <CurrencySelect 
        selectedCurrency={toCurrency}  handleCurrency={e => setToCurrency(e.target.value)}
        />
      </div>
    </div>
    <button type="submit" className={`${isLoading ? "Loading": "" } submit-button`}> Get Exchange Rate</button>
      <p className="exchnage-rate-result">
